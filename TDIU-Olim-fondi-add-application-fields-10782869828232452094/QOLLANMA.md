...
Bu tugma faqat admin kamida bitta sessiya uchun ruxsat bergan talabaga ko'rinadi.

1. Tugmani bosing
2. Ruxsat berilgan sessiyalardan birini tanlang
3. Hujjat mavzusini yozing
4. Bir yoki bir nechta hujjat/rasm yuboring (ko'pi bilan 20 ta)
5. Tasdiqlang — hujjatlar ko'rib chiqish uchun adminlarga yuboriladi
6. Admin tasdiqlasa yoki sabab bilan rad etsa, natija avtomatik xabar qilinadi
...
Tugmada faol sessiya nomi avtomatik ko'rsatiladi va ariza shu sessiyaga biriktiriladi. Bu to'liq anketa bo'lib, quyidagi ma'lumotlar so'raladi:
...
Motivatsion xat matn ko'rinishida yoki DOC/DOCX/PDF/TXT fayl sifatida yuborilishi mumkin.
...
> Birinchi superadmin boshlang'ich sozlamadan yaratiladi. Keyingi adminlar va ularning huquqlari superadmin tomonidan bot ichida boshqariladi.
